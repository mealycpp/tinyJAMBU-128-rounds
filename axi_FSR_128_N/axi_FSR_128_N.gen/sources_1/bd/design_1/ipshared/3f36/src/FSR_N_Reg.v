...
`endif // RANDOMIZE_REG_INIT
  wire [127:0] FSR_128_io_state; // @[FSR_640.scala 51:23]
  wire [127:0] FSR_128_io_key; // @[FSR_640.scala 51:23]
  wire [127:0] FSR_128_io_state_out; // @[FSR_640.scala 51:23]
  reg [127:0] temp_state; // @[FSR_640.scala 47:23]
  reg [9:0] temp_count; // @[FSR_640.scala 49:23]
  wire [9:0] _temp_count_T_1 = temp_count - 10'h1; // @[FSR_640.scala 68:30]
  wire  _T_1 = temp_count == 10'h0; // @[FSR_640.scala 70:25]
  FSR_640 FSR_128 ( // @[FSR_640.scala 51:23]
    .io_state(FSR_128_io_state),
    .io_key(FSR_128_io_key),
    .io_state_out(FSR_128_io_state_out)
  );
  assign io_state_out = temp_count > 10'h0 ? FSR_128_io_state_out : temp_state; // @[FSR_640.scala 54:18 63:26 65:20]
  assign io_done = temp_count > 10'h0 ? 1'h0 : _T_1; // @[FSR_640.scala 60:11 63:26]
  assign FSR_128_io_state = temp_state; // @[FSR_640.scala 53:20]
  assign FSR_128_io_key = io_key; // @[FSR_640.scala 52:18]
  always @(posedge clock) begin
    if (temp_count > 10'h0) begin // @[FSR_640.scala 63:26]
      if (temp_count > 10'h0) begin // @[FSR_640.scala 63:26]
        temp_state <= FSR_128_io_state_out; // @[FSR_640.scala 65:20]
      end
    end
    if (temp_count > 10'h0) begin // @[FSR_640.scala 63:26]
      temp_count <= _temp_count_T_1; // @[FSR_640.scala 68:16]
    end else begin
      temp_count <= io_steps; // @[FSR_640.scala 58:14]
    end
  end
